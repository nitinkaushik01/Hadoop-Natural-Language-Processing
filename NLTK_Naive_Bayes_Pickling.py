...
# pickled_classifier = open("naive_bayes.pickle", "wb")
# pickle.dump(nltk_classifier, pickled_classifier)
# pickled_classifier.close()


pickle_open = open("naive_bayes.pickle", "rb")
nl_classifier = pickle.load(pickle_open)
pickle_open.close()
